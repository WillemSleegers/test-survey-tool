    ...
    <div className="space-y-4">
      ...
      <div className="text-sm space-y-2">
        ...
        <ul className="list-disc list-inside space-y-1">
          ...
          <li>
            <code>HINT: Additional description</code> - {t('guide.features.description')}
          </li>
          <li>
          ...
          <li>
            <code>{`{{IF condition THEN true_text ELSE false_text}}`}</code> - {t('guide.features.conditional')} (ELSE part optional)
            <ul className="list-disc list-inside ml-6 mt-1 space-y-1 text-xs">
              <li><code>{`{{IF age >= 18 THEN As an adult ELSE As someone under 18}}`}</code></li>
              <li><code>{`{{IF rating >= 4 THEN Highly rated!}}`}</code> - IF THEN only (no ELSE part)</li>
              <li><code>{`{{IF recommend THEN {recommend} ELSE Not answered}}`}</code> - Check if variable exists</li>
              <li><code>{`{{IF NOT color THEN Please select a color ELSE You chose {color}}}`}</code> - Check if variable is empty</li>
              <li><code>{`{{IF age >= 18 AND rating >= 4 THEN Adult with high rating ELSE Other}}`}</code> - Multiple conditions</li>
            </ul>
          </li>
          <li>
