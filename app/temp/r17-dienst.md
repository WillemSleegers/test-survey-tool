...
LET OP: omzet opgeven excl. toeristenbelasting.
...
# **Specificatie Omzet dienstverlening naar subactiviteit**
...
- Logies hotels, pensions e.d.
- Logies vakantieparken, campings, jeugdherbergen e.d.
- Verhuur van ingerichte woningen voor tijdelijk verblijf korter dan een jaar (anders dan hotels, pensions en vakantieparken)
- Drank
- Eten
- Ter beschikking stellen van franchiseformules
- Bemiddeling bij accommodatieverhuur door derden
- Amusement en recreatie (speelautomaten, verhuur zalen en banen, etc.)
...
- **_Balanswaarde onderhanden werk en/of gereed product einde boekjaar_**
- COLUMN: 1
- VARIABLE: eindvoorraad
- **_Balanswaarde onderhanden werk en/of gereed product begin boekjaar_**
- COLUMN: 1
...
# **Specificatie directe kosten van de dienstverlening**

NAVIGATION: 2

Q:

- Dranken (horeca-activiteit)
- Keuken (incl. ontbijt, ijs en sorbets)
- Bemiddeling en reservering voor tijdelijke accommodatie, drank en / of maaltijden
- Overige directe kosten dienstverlening niet eerder genoemd
  BREAKDOWN
  PREFIX: €
  SUFFIX: .000,-
  TOTAL: Totaal, moet gelijk zijn aan 'Directe kosten van de dienstverlening'
...
- HINT: Zoals kosten van kantine, arbodiensten, wervingsacties, commissarissenbeloning, opleidingskosten
- COLUMN: 2
  BREAKDOWN
  PREFIX: €
  SUFFIX: .000,-
...
- **Vervoermiddelen**
- HINT: Huur / lease, onderhoud / reparatie, verzekering, houderschapsbelasting en brandstofkosten externe vervoermiddelen (exclusief interne transportmiddelen, zie daarvoor 'Energiekosten')
